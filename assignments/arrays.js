...
for (let i = 0; i > inventory.length; i++){
    if (inventory[i].car_make && inventory[i].car_model === true){
        console.log('The last car make and model is ' + inventory[49].car_make + inventory[49].car_model);
    }
...
let BMWAndAudi = carModels.filter(carModels => carModels === "BMW" && "Audi");
